...
;// CONCATENATED MODULE: ./page-components/common/video-list-menu.tsx
...
/* harmony default export */ const video_list_menu = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/video/menu-video.tsx
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await axios/* default.get */.Z.get(`/video?lang=${lang.value}&page=1&selected=true&limit=1&`);
        return {
            props: {
...
const StreamingPage1 = ({ photos  })=>{
    ...
    return /*#__PURE__*/ jsx_runtime_.jsx(jsx_runtime_.Fragment, {
        children: typeof agendas === "undefined" ? [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(video_list_menu, {
                ...item,
                language: language
            }, item.id))
    });
};
/* harmony default export */ const menu_video = (StreamingPage1);
