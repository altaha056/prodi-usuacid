...
var exports = {};
exports.id = 4875;
exports.ids = [4875,7754,8882,5319,9677,2869,3369];
exports.modules = {
...
;// CONCATENATED MODULE: ./page-components/common/dedication-list.tsx
...
/* harmony default export */ const dedication_list = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/pengabdian-masyarakat/[slug].tsx
...
async function getStaticPaths() {
    try {
        const response = await Promise.all([
            axios/* default.get */.Z.get("/slug/all?lang=id&menu=dedication"),
            axios/* default.get */.Z.get("/slug/all?lang=en&menu=dedication"), 
        ]);
...
const getStaticProps = async (context)=>{
    ...
    try {
        ...
        const response = await axios/* default.get */.Z.get(`/dedication/${context.params.slug}`);
        const research = dedication/* DedicationMaker.create */.h.create(response.data.data) || null;
        return {
            props: {
                research
            },
...
const ResearchDetailPage = ({ research  })=>{
    ...
    const createResearch = ()=>{
        const temp = researchesRes.data.data?.map((rs)=>dedication/* DedicationMaker.create */.h.create(rs));
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                    ...
                                                    children: typeof researches === "undefined" ? [
                                                        ...
                                                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            className: "col-md-12",
                                                            children: /*#__PURE__*/ jsx_runtime_.jsx(dedication_list, {
                                                                ...item,
                                                                language: language
                                                            })
                                                        }, item.id))
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,3614], () => (__webpack_exec__(9147)));
