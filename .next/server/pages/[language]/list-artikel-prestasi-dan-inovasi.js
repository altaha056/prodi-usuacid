...
var exports = {};
exports.id = 2877;
exports.ids = [2877,8882,5319,9677,2869,3369];
exports.modules = {
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await _config_axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"].get */ .Z.get(`/journal?lang=${lang.value}&selected=true&category_id=621601393870224436058284&`);
        return {
            props: {
...
const ResearchPage = ({ photos  })=>{
    ...
    const url = `/journal?lang=${language}&selected=true&limit=10&category_id=621601393870224436058284&`;
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,5695], () => (__webpack_exec__(279)));
