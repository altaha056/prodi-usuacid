...
var exports = {};
exports.id = 8765;
exports.ids = [8765,7754,8882,5319,9677,2869,3369];
exports.modules = {
...
;// CONCATENATED MODULE: ./page-components/common/article-list-news.tsx
...
/* harmony default export */ const article_list_news = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/berita/[slug].tsx
...
async function getStaticPaths() {
    try {
        const response = await Promise.all([
            axios/* default.get */.Z.get("/slug/all?lang=id&menu=news-menu&page=1"),
            axios/* default.get */.Z.get("/slug/all?lang=en&menu=news-menu&page=1"), 
        ]);
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await axios/* default.get */.Z.get(`/news-menu/${context.params.slug}`);
        const news = news_menu/* NewsMenuMaker.create */.E.create(response.data.data) || null;
        return {
            props: {
                news
            },
...
const NewsDetailPage = ({ news  })=>{
    ...
    // create data //
    const createNews = ()=>{
        const temp = newsesRes.data.data?.map((rs)=>news_menu/* NewsMenuMaker.create */.E.create(rs));
                                ...
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            "\xa0",
                                            (0,mapping_sentences/* getKeyValue */.s)(mapping_sentences/* default.liputanUtama */.Z.liputanUtama)((0,check_language/* selectLanguage */.V)(language))
                                        ]
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ jsx_runtime_.jsx(external_react_share_.FacebookShareButton, {
                                                        url: `https://www.usu.ac.id/${language}/berita/${news ? news.slug : ""}`,
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                    ...
                                                    children: typeof newses === "undefined" ? [
                                                        ...
                                                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            className: "col-md-12",
                                                            children: /*#__PURE__*/ jsx_runtime_.jsx(article_list_news, {
                                                                ...item,
                                                                language: language
                                                            })
                                                        }, item.id))
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,3614], () => (__webpack_exec__(6466)));
