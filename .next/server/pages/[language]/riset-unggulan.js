...
var exports = {};
exports.id = 2093;
exports.ids = [2093,8882,5319,9677,2869,3369];
exports.modules = {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ riset_unggulan),
...
;// CONCATENATED MODULE: ./page-components/common/article-list-index.tsx
...
/* harmony default export */ const article_list_index = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/riset-unggulan/index.tsx
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await axios/* default.get */.Z.get(`/photos?lang=${context.params.language}&selected=true&menu=research`);
        return {
            props: {
...
const ResearchPage = ({ photos =[]  })=>{
    ...
    const url = `/research?lang=${language}&selected=true&limit=50&`;
    ...
    const createResearch = ()=>{
        const temp = researchesRes.data.data?.map((research)=>models_research/* ResearchMaker.create */.d.create(research));
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            ...
                            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: typeof researches === "undefined" ? [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(article_list_index, {
                                        ...item,
                                        language: language
                                    }, item.id))
                            })
...
/* harmony default export */ const riset_unggulan = (ResearchPage);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,8577,3614], () => (__webpack_exec__(2345)));
