...
/* harmony import */ var _models_streaming__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(9613);
...
async function getStaticPaths() {
    try {
        const response = await Promise.all([
            _config_axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"].get */ .Z.get("/slug/all?lang=id&menu=streaming"),
            _config_axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"].get */ .Z.get("/slug/all?lang=en&menu=streaming"), 
        ]);
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await _config_axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"].get */ .Z.get(`/streaming/${context.params.slug}`);
        const streaming = _models_streaming__WEBPACK_IMPORTED_MODULE_11__/* .StreamingMaker.create */ .h.create(response.data.data) || null;
        return {
            props: {
                streaming
            },
...
const ResearchDetailPage = ({ streaming  })=>{
    ...
    const createResearch = ()=>{
        const temp = researchesRes.data.data?.map((rs)=>_models_streaming__WEBPACK_IMPORTED_MODULE_11__/* .StreamingMaker.create */ .h.create(rs));
        ...
        children: [
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_head__WEBPACK_IMPORTED_MODULE_2___default()), {
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("title", {
                    children: [
                        (0,helpers_mapping_sentences__WEBPACK_IMPORTED_MODULE_1__/* .getKeyValue */ .s)(helpers_mapping_sentences__WEBPACK_IMPORTED_MODULE_1__/* ["default"].streaming */ .Z.streaming)((0,helpers_check_language__WEBPACK_IMPORTED_MODULE_10__/* .selectLanguage */ .V)(language)),
                        " | Universitas Sumatera Utara"
                    ]
                })
            }),
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("section", {
                className: "ftco-section ftco-section--article-page ftc-no-pb ftco-section--top",
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("a", {
                                            className: "hijau",
                                            href: "",
                                            children: (0,helpers_mapping_sentences__WEBPACK_IMPORTED_MODULE_1__/* .getKeyValue */ .s)(helpers_mapping_sentences__WEBPACK_IMPORTED_MODULE_1__/* ["default"].streaming_content */ .Z.streaming_content)((0,helpers_check_language__WEBPACK_IMPORTED_MODULE_10__/* .selectLanguage */ .V)(language))
                                        }),
...
var __webpack_exports__ = __webpack_require__.X(0, [3271,7318,6378], () => (__webpack_exec__(2635)));
