...
var exports = {};
exports.id = 4198;
exports.ids = [4198,8882,5319,9677,2869,3369];
exports.modules = {
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await _config_axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"].get */ .Z.get(`/bulletin?lang=${lang.value}&selected=true&category_id=621f0c088124ba2ad99b8add&`);
        return {
            props: {
...
const ResearchPage = ({ photos  })=>{
    ...
    const url = `/bulletin?lang=${language}&selected=true&limit=10&category_id=621f0c088124ba2ad99b8add&`;
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,1987], () => (__webpack_exec__(6769)));
