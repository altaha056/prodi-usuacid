...
import ArticleOutlinePublicLectureList from '@/page-components/common/publicLecture-outline-list';
...
const ArticleOutlinePublicLecture: React.FC = ({}) => {
  ...
  return (
    <>
      {researches ? (
        researches.map((item) => (
          <ArticleOutlinePublicLectureList
            key={item.id}
            data={item}
            language={language}
          />
...
export default ArticleOutlinePublicLecture;
