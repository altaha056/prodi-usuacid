...
import ArticleOutlineAgendaList from '@/page-components/common/agenda-outline-list';
...
const ArticleOutlineAgenda: React.FC = ({}) => {
...
export default ArticleOutlineAgenda;
