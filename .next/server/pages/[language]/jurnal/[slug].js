...
var exports = {};
exports.id = 4271;
exports.ids = [4271,8882,5319,9677,2869,3369];
exports.modules = {
...
;// CONCATENATED MODULE: ./page-components/common/article-list-jurnal.tsx
...
/* harmony default export */ const article_list_jurnal = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/jurnal/[slug].tsx
...
async function getStaticPaths() {
    try {
        const response = await Promise.all([
            axios/* default.get */.Z.get("/slug/all?lang=id&menu=journal&page=1"),
            axios/* default.get */.Z.get("/slug/all?lang=en&menu=journal&page=1"), 
        ]);
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await axios/* default.get */.Z.get(`/journal/${context.params.slug}`);
        const news = journal/* JournalMaker.create */.w.create(response.data.data) || null;
        return {
            props: {
                news
            },
...
const NewsDetailPage = ({ news  })=>{
    ...
    const url = `/journal?lang=${language}&selected=true&page=1&`;
    ...
    // create data //
    const createNews = ()=>{
        const temp = newsesRes.data.data?.map((rs)=>journal/* JournalMaker.create */.w.create(rs));
            ...
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)((head_default()), {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("title", {
                        children: [
                            (0,mapping_sentences/* getKeyValue */.s)(mapping_sentences/* default.artikel_content */.Z.artikel_content)((0,check_language/* selectLanguage */.V)(language)),
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        ...
                                        children: /*#__PURE__*/ jsx_runtime_.jsx("a", {
                                            href: `/${language}/jurnal`,
                                            children: (0,mapping_sentences/* getKeyValue */.s)(mapping_sentences/* default.artikel_content */.Z.artikel_content)((0,check_language/* selectLanguage */.V)(language))
                                        })
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ jsx_runtime_.jsx(external_react_share_.FacebookShareButton, {
                                                        url: `https://www.usu.ac.id/${language}/jurnal/${news ? news.slug : ""}`,
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                    ...
                                                    children: typeof newses === "undefined" ? [
                                                        ...
                                                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                                            className: "col-md-12",
                                                            children: /*#__PURE__*/ jsx_runtime_.jsx(article_list_jurnal, {
                                                                ...item,
                                                                language: language
                                                            })
                                                        }, item.id))
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,3614], () => (__webpack_exec__(5455)));
