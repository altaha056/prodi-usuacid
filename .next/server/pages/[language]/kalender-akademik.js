...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await _config_axios__WEBPACK_IMPORTED_MODULE_9__/* ["default"].get */ .Z.get(`/photos?lang=${context.params.language}&menu=article&category_id=6077ed8734b4c46f67203be5`);
        return {
            props: {
...
var __webpack_exports__ = __webpack_require__.X(0, [3271,7318,6378,4077], () => (__webpack_exec__(3794)));
