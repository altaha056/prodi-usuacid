...
import ArticleOutlineDedicationList from '@/page-components/common/dedication-outline-list';
...
const ArticleOutlineDedication: React.FC = ({}) => {
...
export default ArticleOutlineDedication;
