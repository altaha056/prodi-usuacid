...
var exports = {};
exports.id = 2018;
exports.ids = [2018,8882,5319,9677,2869,3369];
exports.modules = {
...
;// CONCATENATED MODULE: ./page-components/common/article-list-main-focus-index.tsx




const ArticleList = ({ title , image , date , slug , language , shortDescription ,  })=>/*#__PURE__*/ jsx_runtime_.jsx("section", {
        className: "ftc-no-pb",
...
/* harmony default export */ const article_list_main_focus_index = (ArticleList);
...
;// CONCATENATED MODULE: ./pages/[language]/fokus-utama/index.tsx
...
const getStaticProps = async (context)=>{
    ...
    try {
        const response = await axios/* default.get */.Z.get(`/photos?lang=${context.params.language}&selected=true&menu=main-focus`);
        return {
            props: {
...
const ResearchPage = ({ photos =[]  })=>{
    ...
    const createResearch = ()=>{
        const temp = researchesRes.data.data?.map((research)=>main_focus/* MainFocusMaker.create */.M.create(research));
        ...
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx((head_default()), {
                children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("title", {
                    children: [
                        (0,mapping_sentences/* getKeyValue */.s)(mapping_sentences/* default.mainFocus */.Z.mainFocus)((0,check_language/* selectLanguage */.V)(language)),
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx("a", {
                                        className: "hijau",
                                        href: "",
                                        children: (0,mapping_sentences/* getKeyValue */.s)(mapping_sentences/* default.mainFocus_content */.Z.mainFocus_content)((0,check_language/* selectLanguage */.V)(language))
                                    }),
                        ...
                        /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            ...
                            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                ...
                                children: typeof researches === "undefined" ? [
                                    ...
                                    /*#__PURE__*/ jsx_runtime_.jsx(article_list_main_focus_index, {
                                        ...item,
                                        language: language
                                    }, item.id))
                            })
...
/* harmony default export */ const fokus_utama = (ResearchPage);
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,3271,7318,6378,8577,3614], () => (__webpack_exec__(7361)));
